...
const Icons = {
  ...
  Funnel: () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>,
  Flux: () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><line x1="6" y1="9" x2="6" y2="15"/><circle cx="18" cy="18" r="3"/><path d="M6 9a9 9 0 0 1 9 9"/></svg>,
...
export function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: "Funis de Vendas", path: "/dashboard/funnels", icon: Icons.Funnel },
    { name: "Fluxos", path: "/dashboard/flows", icon: Icons.Flux },
  ...
  return (
    <aside className={styles.aside}>
      <div className={styles.logoContainer}>
        <span className={styles.logoText}>SellFlux<span style={{color:'#6366f1'}}>.</span></span>
